package br.com.edsonmoretti.rest.unittests.mapper
...
import br.com.edsonmoretti.rest.unittests.mapper.mocks.MockPerson
...
class DozerMapperTest {
    ...
    fun parseEntityListToVOListTest() {
        val outputList: ArrayList<PersonVO> =
            DozerMapper.parseObjects(inputObject!!.mockEntityList(), PersonVO::class.java)
    ...
    fun parserVOListToEntityListTest() {
        ...
        val outputList: ArrayList<Person> = DozerMapper.parseObjects(inputObject!!.mockVOList(), Person::class.java)
